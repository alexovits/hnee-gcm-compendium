  ...
  <div className={styles.container}>
    ...
    <main className={styles.mainArticle}>
      ...
      <div className={styles.articleContainer}>
        ...
        <p>In Costa Rican culture, deep respect for nature plays a vital role. The national motto “pura vida” (English “pure life”) means gratitude for and peace with oneself and the surrounding environment. According to Stewart Maginnis, global director of the nature-based solutions group at the International Union for Conservation of Nature (IUCN), this value has played a vital role in Costa Rica’s reforestation success (Lewis, 2020).</p>
